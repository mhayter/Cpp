...
int main() {
	...
	for(int numCase=1;numCase<=nCases;numCase++) {
		...
		if (output.m_dataOffset + 32 > sizeof(output.m_data)) output.Flush();
		output.m_data[output.m_dataOffset++] = 'C';
		output.m_data[output.m_dataOffset++] = 'a';
		output.m_data[output.m_dataOffset++] = 's';
		output.m_data[output.m_dataOffset++] = 'e';
		output.m_data[output.m_dataOffset++] = ' ';
		output.m_data[output.m_dataOffset++] = '#';
		...
		*/
		...
		if(dist[destination]==INF) {
			...
			output.m_data[output.m_dataOffset++] = 'u';
			output.m_data[output.m_dataOffset++] = 'n';
			output.m_data[output.m_dataOffset++] = 'r';
			output.m_data[output.m_dataOffset++] = 'e';
			output.m_data[output.m_dataOffset++] = 'a';
			output.m_data[output.m_dataOffset++] = 'c';
			output.m_data[output.m_dataOffset++] = 'h';
			output.m_data[output.m_dataOffset++] = 'a';
			output.m_data[output.m_dataOffset++] = 'b';
			output.m_data[output.m_dataOffset++] = 'l';
			output.m_data[output.m_dataOffset++] = 'e';
			output.m_data[output.m_dataOffset++] = '\n';
