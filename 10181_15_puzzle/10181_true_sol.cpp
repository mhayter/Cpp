...
/*
36% better than my implementation: again_improved without 5/3*hv improvement
*/
struct status {
    char board[4][4];
    int ix, iy;
...
int main() {
    ...
    while(test--) {
        ...
        if(solvable()) {
            ...
            while(solved == 0 && mxdep<=50)
                mxdep = IDA(0, initH, -1);
            if (mxdep>50) {
                puts("SHIT This puzzle is not solvable.");
            }
            //printf("%d\n", solved);
        }else {
